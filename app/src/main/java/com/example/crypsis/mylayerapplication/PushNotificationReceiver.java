...
public class PushNotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (intent.getAction().equals(ACTION_PUSH)) {
            ...
            LayerClient layerClient = MyApp.getLayerClient();
    ...
    public static class Notifications {
        ...
        private void update(Context context, Conversation conversation, Message message) {
            ...
            String conversationTitle = Util.getConversationTitle(MyApp.getLayerClient(), conversation);
        ...
        private static PendingIntent createNotificationClickIntent(Context context, Uri conversationId, Uri messageId) {
            Intent clickIntent = new Intent(context, MessagesActivity.class)
